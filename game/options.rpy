...
define config.name = _("The Midnight Dance")
...
define build.name = "midnight_dance"
...
define config.end_game_transition = Fade(3.0, 3.0, 0.0, color="#FFF")
...
define config.save_directory = "midnight_dance"
